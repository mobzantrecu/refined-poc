...
import com.bewise.backend.service.PostQueryService;
import com.bewise.backend.service.PostService;
import com.bewise.backend.service.criteria.PostCriteria;
import com.bewise.backend.service.dto.PostDTO;
import com.bewise.backend.web.rest.errors.BadRequestAlertException;
import java.net.URI;
...
/**
 * REST controller for managing {@link com.bewise.backend.domain.Post}.
 */
@RestController
@RequestMapping("/api")
public class PostResource {
    ...
    private static final String ENTITY_NAME = "backendPost";
    ...
    public ResponseEntity<List<PostDTO>> getAllPosts(
        ...
        log.debug("REST request to get Posts by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
    ...
    public ResponseEntity<Long> countPosts(PostCriteria criteria) {
        log.debug("REST request to count Posts by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
